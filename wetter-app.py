...
class GUI:
    def __init__(self):
        ...
        # Eine Lambda-Funktion wird verwendet, um self.update_font_size() mit dem event-Parameter aufzurufen
        self.fenster.bind("<Configure>", lambda event: self.update_font_size())
    ...
    def update_font_size(self):
        ...
        # Calculate a font size based on window size (e.g., 10% of the window width)
        bild_fontSize = int(fensterBreite * 0.2)  # Adjust the multiplier as needed
        temperatur_fontSize = int(fensterBreite * 0.05)  # Adjust the multiplier as needed
...
class WetterApp:
    ...
    def warnungen(self, wetter_daten):
        ...
        if windGeschwindigkeit >= 50:
            ...
            warnungen.append("Moderater Wind, Vorsicht geboten. und nicht nach drau-en gehen")
        ...
        # Aktualisiere das Label den Warnungen
