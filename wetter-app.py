...
auth_token = '83eea50afe89ec5197a8acd4a72b2a6f'
...
class WetterApp:
    ...
    def warnungen(self, wetter_daten):
        ...
        elif windGeschwindigkeit >= 300:  # 30
            warnungen.append("Tornado")
            warnungenSMS.append("Achtung: Tornadogefahr in Ihrer Nähe!")
...
#             )
    ...
    def hintergrundfarbe(self):
        ...
        # self.aktuelle_zeit = datetime.datetime(2025, 3, 12, 23, 0, 0, 0)
