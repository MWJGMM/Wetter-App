...
class GUI:
    def __init__(self):
        ...
        self.fenster.configure(bg="#595959")
        ...
        ###### Eingabefeld ######
        self.eingabe_frame = Frame(self.fenster, bg="#595959")
        self.eingabe_frame.grid(row=1, column=0, columnspan=2, sticky="ew", padx=40, pady=10) 
        
        self.label_standort = Label(self.eingabe_frame, text="Standort:", font=("Segoe UI Semibold", 24), bg="#595959", fg="white")
        ...
        self.eingabefeld.insert(0, "Berlin") # Am Anfang einfügen, Index 0

        ###### Linke Seite (Wetterinfos) ######
        self.linke_seite = Frame(self.fenster, bg="#595959")
        self.linke_seite.grid(row=2, column=0, sticky="nsew", padx=(40, 5), pady=20) # Grid: sticky="nsew" in alle Richtungen ausdehnen
        
        self.label_aktuell = Label(self.linke_seite, text="Aktuell:", font=("Segoe UI Semibold", 18), bg="#595959", fg="white")
        ...
        self.label_temperatur = Label(self.linke_seite, text="0°C", font=("Segoe UI Semibold", 80), bg="#595959", fg="white")
        ...
        self.label_aktuell = Label(self.rechte_seite, text="Warnung:", font=("Segoe UI Semibold", 18), bg="#404040", fg="white")
